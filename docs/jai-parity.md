...
Its `tests/` directory is 40+ files of real Jai syntax corner cases — here-strings, `ifx`,
inline assembly, broader defaulted/implicit named-return semantics, `#exists`, import-with-arguments, discard,
