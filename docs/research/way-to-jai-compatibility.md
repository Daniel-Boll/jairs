...
| 17 — Procedures | Defaults/named args, multiple returns, `#must`, overloads, inline, `#this`, reflection, anonymous procs | **Partial** | Local/nested procedures, procedure values, literal defaults, named arguments, several returns, `#must`, recursion, and operator overloading exist. General procedure overloading, named returns, anonymous/lambda procedures, `inline`, `#this`, `#procedure_name`, `#deprecated`, and full procedure reflection do not. |
...
3. Named returns, anonymous/lambda procedures, inline controls, and `#this`.
