...
| 18A — Arrays | Fixed/dynamic arrays, views, literals, variadics, reverse and pointer iteration | **Partial** | `[N]T`, `[]T`, `[..]T`, typed `T.[...]` literals, bounded direct indexing of fixed/view/dynamic arrays, ordinary and reverse loops over their elements, and variadic `..T` packing exist. Dynamic-array indexing and iteration use the used `count`, not spare capacity (ADR-0242). Inferred `.[...]`, multidimensional conveniences, by-reference iteration, broad generic array helpers, dynamic-array slicing, and arbitrary evaluated lengths do not. |
