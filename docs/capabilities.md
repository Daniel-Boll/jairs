...
- **280** `.jr` corpus files under `tests/corpus/` outside `tests/corpus/modules/`
  (**290** counting those).
- **197** accepted ADRs — see [`docs/adr/README.md`](adr/README.md).
