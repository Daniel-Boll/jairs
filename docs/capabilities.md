...
| named arguments `f(b = 2, a = 1)` and literal defaults `(b: s64 = 10)`, including imported calls and `#run` | a non-literal default; inferred default syntax such as `(b := 10)`; names/defaults through a procedure pointer |
