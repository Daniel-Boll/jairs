...
#pill[980 tests]
#h(4pt)
#pill[ADR-0095 latest]
#h(4pt)
#pill(fill: rgb("#fdf2e6"), stroke: warn)[W5 open · 13 sub-waves done]
...
#grid(
  ...
  metric("Corpus", "190", "jr files, both engines"),
  metric("ADRs", "95", "0001 to 0095, immutable"),
  metric("Diagnostics", "106", "codes, E0276 next free"),
...
#grid(
  ...
  gutter: 14pt,
  [
    #sub[Forty-seven waves shipped]
    #text(size: 7.4pt)[
      ADR-0049 through 0095: for and defer, using, aggregate returns, multiple returns, named and
    ...
    #v(0.3em)
    #text(size: 7.4pt)[
      Test count 900 to 980. Corpus 116 to 190 files. Neovim checks 103 to 166. *W2, W3, W4.5 and W4 are all
      ...
      Remaining in W5: `#bake_arguments`.
    ]
