...
#pill[986 tests]
#h(4pt)
#pill[ADR-0116 latest]
#h(4pt)
#pill(fill: rgb("#fdf2e6"), stroke: warn)[W7 OPEN · 14 sub-waves]
...
#grid(
  ...
  metric("Corpus", "206", "jr files, both engines"),
  metric("ADRs", "117", "0001 to 0117, immutable"),
