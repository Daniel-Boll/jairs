...
#pill[978 tests]
#h(4pt)
#pill[ADR-0090 latest]
#h(4pt)
#pill(fill: rgb("#fdf2e6"), stroke: warn)[W5 open · 8 sub-waves done]

#v(0.5em)
#grid(
  columns: (1fr, 1fr, 1fr, 1fr, 1fr),
  gutter: 8pt,
  metric("Tests", "978", "workspace, all passing"),
  metric("Corpus", "184", "jr files, both engines"),
  metric("ADRs", "90", "0001 to 0090, immutable"),
  metric("Diagnostics", "104", "codes, E0273 next free"),
...
#grid(
  ...
  gutter: 14pt,
  [
    #sub[Forty-two waves shipped]
    #text(size: 7.4pt)[
      ADR-0049 through 0090: for and defer, using, aggregate returns, multiple returns, named and
    ...
    #v(0.3em)
    #text(size: 7.4pt)[
      Test count 900 to 978. Corpus 116 to 184 files. Neovim checks 103 to 166. *W2, W3, W4.5 and W4 are all
      ...
      Remaining in W5: the `#expand` splice, then `#modify` and `#bake_arguments`.
    ]
