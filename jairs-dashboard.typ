...
#pill[986 tests]
#h(4pt)
#pill[ADR-0115 latest]
#h(4pt)
#pill(fill: rgb("#fdf2e6"), stroke: warn)[W7 OPEN · 13 sub-waves]
...
#grid(
  ...
  metric("Corpus", "204", "jr files, both engines"),
  metric("ADRs", "116", "0001 to 0116, immutable"),
