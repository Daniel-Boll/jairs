...
#pill[979 tests]
#h(4pt)
#pill[ADR-0091 latest]
#h(4pt)
#pill(fill: rgb("#fdf2e6"), stroke: warn)[W5 open · 9 sub-waves done]

#v(0.5em)
#grid(
  columns: (1fr, 1fr, 1fr, 1fr, 1fr),
  gutter: 8pt,
  metric("Tests", "979", "workspace, all passing"),
  metric("Corpus", "186", "jr files, both engines"),
  metric("ADRs", "91", "0001 to 0091, immutable"),
  metric("Diagnostics", "105", "codes, E0274 next free"),
...
#grid(
  ...
  gutter: 14pt,
  [
    #sub[Forty-three waves shipped]
    #text(size: 7.4pt)[
      ADR-0049 through 0091: for and defer, using, aggregate returns, multiple returns, named and
    ...
    #v(0.3em)
    #text(size: 7.4pt)[
      Test count 900 to 979. Corpus 116 to 186 files. Neovim checks 103 to 166. *W2, W3, W4.5 and W4 are all
      ...
      Remaining in W5: `#modify` and `#bake_arguments`.
    ]
