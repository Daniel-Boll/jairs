...
#h(4pt)
#pill(fill: rgb("#fdf2e6"), stroke: warn)[W7 OPEN · 6 sub-waves]

#v(0.5em)
#grid(
  columns: (1fr, 1fr, 1fr, 1fr, 1fr),
  gutter: 8pt,
  metric("Tests", "985", "workspace, all passing"),
  metric("Corpus", "193", "jr files, both engines"),
  metric("ADRs", "109", "0001 to 0109, immutable"),
...
#grid(
  ...
  [
    ...
    #v(0.3em)
    #text(size: 7.4pt)[
      Test count 900 to 985. Corpus 116 to 198 files. Neovim checks 103 to 166. *W2, W3, W4.5, W4 and W5 are all
