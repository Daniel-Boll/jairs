...
Then W6's remaining metaprogram work (the static-data table for the message loop) and W7's
remaining modules (merge sort with an allocation policy, `String.split`, `File`, etc.).
