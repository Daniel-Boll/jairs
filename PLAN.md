...
Tests **1073 → 1076** (**1080** under gate 7); the workspace corpus **262 → 265** `.jr` files under
`tests/corpus/` outside `tests/corpus/modules/` (275 counting those). **E0295 is the first free code.** ADRs
182 → **184**.
...
**Newly owed, from ADR-0183/0184, and each named where it bit rather than left to be rediscovered:**
