...
Accepted ADRs: 0001–0143. See [`docs/adr/README.md`](docs/adr/README.md). (This line
...
**W8 — Performance is OPEN**, two sub-waves in (ADR-0142, the optimisation level; ADR-0143, the LLVM back end). **W7 — Stdlib is
...
worked. **1019 workspace tests** (1020 under gate 7) and **228 corpus files**, all six gates green **locally**, plus the new **gate 7** (the LLVM back end, which needs an installed LLVM 21) — no CI run
