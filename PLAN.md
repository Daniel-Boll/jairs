...
**W6 — Metaprogram is OPEN**, four sub-waves in, and its headline claim is met: **a metaprogram can find
declarations by note and generate code for each one** (ADR-0101). A declaration can carry `@name`/`@name "payload"` metadata
...
with no VM and no new query. **981 workspace tests** and **188 corpus files**, all six gates green, **166 Neovim checks**. See §1.5.
