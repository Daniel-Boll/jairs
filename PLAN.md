...
Accepted ADRs: 0001–0144. See [`docs/adr/README.md`](docs/adr/README.md). (This line
...
**W8 — Performance is OPEN**, three sub-waves in (ADR-0142, the optimisation level; ADR-0143, the LLVM back end; ADR-0144, `#align`/`#place`). **W7 — Stdlib is
...
worked. **1027 workspace tests** (1028 under gate 7) and **231 corpus files**, all six gates green **locally**, plus the new **gate 7** (the LLVM back end, which needs an installed LLVM 21) — no CI run
...
> `tests/corpus/` *outside* `tests/corpus/modules/` — 115 `valid` + 10 `invalid` + 73 `type-errors` +
> 3 `cfg-errors` + 30 `imports` = 231. Counting the 10 module fixtures too gives 241. This section
