...
**W5 — Polymorphism is OPEN, seven sub-waves done.** `$T` procedures, polymorphic structs, and `$N`
comptime-value parameters are **complete** — surface, instantiation, and `[N]T` sized by one.
**978 workspace tests**, all six gates green, **166 Neovim checks**. See §1.5.
