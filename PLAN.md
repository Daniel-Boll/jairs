...
worked. **1033 workspace tests** (1034 under gate 7) and **237 corpus files**, all six gates green **locally**, plus the new **gate 7** (the LLVM back end, which needs an installed LLVM 21) — no CI run
