...
; literal token rather than a `(directive)` node, so the general `(directive) @keyword`
...
(align_attr "#align" @keyword)
(place_attr "#place" @keyword)
...
; Function calls
(call_expr function: (name_expr (identifier) @function))
(call_expr function: (field_expr field: (identifier) @function))
